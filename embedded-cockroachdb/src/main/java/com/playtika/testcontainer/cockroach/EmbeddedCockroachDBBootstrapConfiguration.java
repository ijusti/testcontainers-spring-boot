...
public class EmbeddedCockroachDBBootstrapConfiguration {
    ...
    public ToxiproxyContainer.ContainerProxy cockroachContainerProxy(ToxiproxyContainer toxiproxyContainer,
                                                                    @Qualifier(BEAN_NAME_EMBEDDED_COCKROACHDB) CockroachContainer cockroachContainer) {
        return toxiproxyContainer.getProxy(cockroachContainer, CockroachDBProperties.PORT);
    }
