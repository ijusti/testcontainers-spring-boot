...
public class EmbeddedOpenSearchBootstrapConfiguration {
    ...
    public DynamicPropertyRegistrar opensearchToxiProxyDynamicPropertyRegistrar(ToxiproxyContainer toxiproxyContainer,
        ...
        return registry -> {
            ...
            registry.add("embedded.opensearch.toxiproxy.host", proxy::getContainerIpAddress);
            registry.add("embedded.opensearch.toxiproxy.port", proxy::getProxyPort);
            registry.add("embedded.opensearch.toxiproxy.proxyName", proxy::getName);
            log.info("Started OpenSearch ToxiProxy connection details host={}, port={}, proxyName={}", proxy.getContainerIpAddress(), proxy.getProxyPort(), proxy.getName());
        };
    }
