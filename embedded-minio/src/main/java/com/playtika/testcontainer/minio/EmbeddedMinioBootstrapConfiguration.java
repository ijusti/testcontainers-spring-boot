...
public class EmbeddedMinioBootstrapConfiguration {
    ...
    public ToxiproxyContainer.ContainerProxy minioContainerProxy(ToxiproxyContainer toxiproxyContainer,
                                                                @Qualifier(BEAN_NAME_EMBEDDED_MINIO) GenericContainer<?> minio,
                                                                MinioProperties properties) {
        return toxiproxyContainer.getProxy(minio, properties.getPort());
    }
