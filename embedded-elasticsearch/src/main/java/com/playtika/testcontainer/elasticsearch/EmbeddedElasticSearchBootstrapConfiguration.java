...
public class EmbeddedElasticSearchBootstrapConfiguration {
    ...
    public ToxiproxyContainer.ContainerProxy elasticsearchContainerProxy(ToxiproxyContainer toxiproxyContainer,
        ...
        log.info("Started ElasticSearch ToxiProxy connection details host={}, port={}, proxyName={}", proxy.getContainerIpAddress(), proxy.getProxyPort(), proxy.getName());
        return proxy;
    }
