...
public class EmbeddedMariaDBBootstrapConfiguration {
    ...
    public ToxiproxyContainer.ContainerProxy mariadbContainerProxy(ToxiproxyContainer toxiproxyContainer,
                                                                  @Qualifier(BEAN_NAME_EMBEDDED_MARIADB) MariaDBContainer mariadbContainer,
                                                                  MariaDBProperties properties) {
        return toxiproxyContainer.getProxy(mariadbContainer, properties.getPort());
    }
