...
public class EmbeddedNeo4jBootstrapConfiguration {
    ...
    public ToxiproxyContainer.ContainerProxy neo4jContainerProxy(ToxiproxyContainer toxiproxyContainer,
        ...
        log.info("Started Neo4j ToxiProxy connection details host={}, port={}, proxyName={}", proxy.getContainerIpAddress(), proxy.getProxyPort(), proxy.getName());
        return proxy;
    }
