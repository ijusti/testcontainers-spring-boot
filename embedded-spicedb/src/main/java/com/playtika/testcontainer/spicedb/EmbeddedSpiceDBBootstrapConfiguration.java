...
public class EmbeddedSpiceDBBootstrapConfiguration {
    ...
    public ToxiproxyContainer.ContainerProxy spicedbContainerProxy(ToxiproxyContainer toxiproxyContainer,
                                                                  @Qualifier(BEAN_NAME_EMBEDDED_SPICEDB) GenericContainer<?> spicedb,
                                                                  SpiceDBProperties properties) {
        return toxiproxyContainer.getProxy(spicedb, properties.getPort());
    }
