...
public class EmbeddedGrafanaBootstrapConfiguration {
    ...
    public ToxiproxyContainer.ContainerProxy grafanaContainerProxy(ToxiproxyContainer toxiproxyContainer,
                                                                  @Qualifier(GRAFANA_BEAN_NAME) GenericContainer<?> grafana,
                                                                  GrafanaProperties properties) {
        return toxiproxyContainer.getProxy(grafana, properties.getPort());
    }
