...
public class EmbeddedVictoriaMetricsBootstrapConfiguration {
    ...
    public ToxiproxyContainer.ContainerProxy victoriaMetricsContainerProxy(ToxiproxyContainer toxiproxyContainer,
                                                                          @Qualifier(BEAN_NAME_EMBEDDED_VICTORIA_METRICS) GenericContainer<?> victoriaMetrics,
                                                                          VictoriaMetricsProperties properties) {
        return toxiproxyContainer.getProxy(victoriaMetrics, properties.port);
    }
