...
public class EmbeddedDb2BootstrapConfiguration {
    ...
    public ToxiproxyContainer.ContainerProxy db2ContainerProxy(ToxiproxyContainer toxiproxyContainer,
        ...
        log.info("Started DB2 ToxiProxy connection details host={}, port={}, proxyName={}", proxy.getContainerIpAddress(), proxy.getProxyPort(), proxy.getName());
        return proxy;
    }
