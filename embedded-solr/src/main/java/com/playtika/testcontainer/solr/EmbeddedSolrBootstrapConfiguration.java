...
public class EmbeddedSolrBootstrapConfiguration {
    ...
    public ToxiproxyContainer.ContainerProxy solrContainerProxy(ToxiproxyContainer toxiproxyContainer,
        ...
        log.info("Started Solr ToxiProxy connection details host={}, port={}, proxyName={}", proxy.getContainerIpAddress(), proxy.getProxyPort(), proxy.getName());
        return proxy;
    }
