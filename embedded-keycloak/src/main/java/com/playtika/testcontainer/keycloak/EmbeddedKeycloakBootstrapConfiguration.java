...
public class EmbeddedKeycloakBootstrapConfiguration {
    ...
    public ToxiproxyContainer.ContainerProxy keycloakContainerProxy(ToxiproxyContainer toxiproxyContainer,
        ...
        log.info("Started Keycloak ToxiProxy connection details host={}, port={}, proxyName={}", proxy.getContainerIpAddress(), proxy.getProxyPort(), proxy.getName());
        return proxy;
    }
